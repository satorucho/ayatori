...
- GitHub Pages: `https://<user>.github.io/ayatori/ayatori.iife.js`
...
const AYATORI_CDN = "https://<user>.github.io/ayatori/ayatori.iife.js";
...
<body>
  <div id="root"></div>
  <script src="https://<user>.github.io/ayatori/ayatori.iife.js"></script>
  <script>
    const yaml = `
meta:
  name: 簡単な承認フロー
