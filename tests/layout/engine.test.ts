...
const simpleFlow: FlowChartSchema = {
  ...
  nodes: [
    ...
    { id: "n2", type: "process", label: "申請書を作成する", sublabel: "申請システム", lane: "lane-a", phase: null, style: "default", comments: [], decisionMeta: null, timeLabel: null },
    { id: "n3", type: "decision", label: "内容に\n不備はないか", sublabel: null, lane: "lane-b", phase: null, style: "default", comments: [], decisionMeta: { branchNumber: 1, yesDirection: "down", noDirection: "right" }, timeLabel: null },
    { id: "n4", type: "process", label: "差し戻す", sublabel: null, lane: "lane-b", phase: null, style: "orange", comments: [], decisionMeta: null, timeLabel: null },
    { id: "n5", type: "process", label: "承認する", sublabel: "申請システム", lane: "lane-b", phase: null, style: "default", comments: [], decisionMeta: null, timeLabel: null },
    { id: "n6", type: "end", label: "完了", sublabel: null, lane: "lane-b", phase: null, style: "default", comments: [], decisionMeta: null, timeLabel: null },
  ],
  edges: [
...
const multiPhaseFlow: FlowChartSchema = {
  ...
  nodes: [
    { id: "s", type: "start", label: "開始", sublabel: null, lane: "lane-a", phase: "ph1", style: "default", comments: [], decisionMeta: null, timeLabel: null },
    { id: "a1", type: "process", label: "A1", sublabel: null, lane: "lane-a", phase: "ph1", style: "default", comments: [], decisionMeta: null, timeLabel: null },
    { id: "b1", type: "process", label: "B1", sublabel: null, lane: "lane-a", phase: "ph2", style: "default", comments: [], decisionMeta: null, timeLabel: null },
    { id: "b2", type: "process", label: "B2", sublabel: null, lane: "lane-b", phase: "ph2", style: "default", comments: [], decisionMeta: null, timeLabel: null },
    { id: "b3", type: "process", label: "B3", sublabel: null, lane: "lane-a", phase: "ph2", style: "default", comments: [], decisionMeta: null, timeLabel: null },
    { id: "b4", type: "process", label: "B4", sublabel: null, lane: "lane-b", phase: "ph2", style: "default", comments: [], decisionMeta: null, timeLabel: null },
    { id: "b5", type: "process", label: "B5", sublabel: null, lane: "lane-b", phase: "ph2", style: "default", comments: [], decisionMeta: null, timeLabel: null },
    { id: "b-end", type: "end", label: "B-End", sublabel: null, lane: "lane-b", phase: "ph2", style: "default", comments: [], decisionMeta: null, timeLabel: null },
    { id: "c1", type: "process", label: "C1", sublabel: null, lane: "lane-a", phase: "ph3", style: "default", comments: [], decisionMeta: null, timeLabel: null },
    { id: "c2", type: "process", label: "C2", sublabel: null, lane: "lane-a", phase: "ph3", style: "default", comments: [], decisionMeta: null, timeLabel: null },
    { id: "c3", type: "process", label: "C3", sublabel: null, lane: "lane-a", phase: "ph3", style: "default", comments: [], decisionMeta: null, timeLabel: null },
  ],
  edges: [
